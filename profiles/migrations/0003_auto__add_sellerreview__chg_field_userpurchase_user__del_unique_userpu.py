...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserPurchase', fields ['user']
        db.delete_unique(u'profiles_userpurchase', ['user_id'])

        # Adding model 'SellerReview'
        db.create_table(u'profiles_sellerreview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'profiles', ['SellerReview'])


        # Changing field 'UserPurchase.user'
        db.alter_column(u'profiles_userpurchase', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting model 'SellerReview'
        db.delete_table(u'profiles_sellerreview')


        # Changing field 'UserPurchase.user'
        db.alter_column(u'profiles_userpurchase', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'UserPurchase', fields ['user']
        db.create_unique(u'profiles_userpurchase', ['user_id'])
