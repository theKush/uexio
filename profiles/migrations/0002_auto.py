...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field product on 'UserPurchase'
        db.delete_table(db.shorten_name(u'profiles_userpurchase_product'))
    ...
    def backwards(self, orm):
        # Adding M2M table for field product on 'UserPurchase'
        m2m_table_name = db.shorten_name(u'profiles_userpurchase_product')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userpurchase', models.ForeignKey(orm[u'profiles.userpurchase'], null=False)),
            ('product', models.ForeignKey(orm[u'products.product'], null=False))
