...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'profiles_userprofile', (
            ...
            ('paypal', self.gf('django.db.models.fields.EmailField')(max_length=70, unique=True, null=True)),
            ('phonenumber', self.gf('django.db.models.fields.CharField')(max_length=40, unique=True, null=True)),
        ))
