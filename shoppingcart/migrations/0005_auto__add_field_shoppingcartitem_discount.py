...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShoppingcartItem.discount'
        db.add_column(u'shoppingcart_shoppingcartitem', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShoppingcartItem.discount'
        db.delete_column(u'shoppingcart_shoppingcartitem', 'discount')
