...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Shoppingcart.active'
        db.delete_column(u'shoppingcart_shoppingcart', 'active')

        # Deleting field 'Shoppingcart.total'
        db.delete_column(u'shoppingcart_shoppingcart', 'total')


    def backwards(self, orm):
        # Adding field 'Shoppingcart.active'
        db.add_column(u'shoppingcart_shoppingcart', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Shoppingcart.total'
        db.add_column(u'shoppingcart_shoppingcart', 'total',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=50, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'shoppingcart.shoppingcartitem': {
            ...
            'discount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
