...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShoppingcartItem.quantity'
        db.delete_column(u'shoppingcart_shoppingcartitem', 'quantity')


    def backwards(self, orm):
        # Adding field 'ShoppingcartItem.quantity'
        db.add_column(u'shoppingcart_shoppingcartitem', 'quantity',
