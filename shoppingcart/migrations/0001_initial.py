...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shoppingcart_shoppingcart', (
            ...
            ('total', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=50, decimal_places=2)),
        ...
        # Adding model 'ShoppingcartItem'
        db.create_table(u'shoppingcart_shoppingcartitem', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shoppingcart', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shoppingcart.Shoppingcart'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Product'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'shoppingcart', ['ShoppingcartItem'])


    def backwards(self, orm):
        # Deleting model 'Shoppingcart'
        db.delete_table(u'shoppingcart_shoppingcart')

        # Deleting model 'ShoppingcartItem'
        db.delete_table(u'shoppingcart_shoppingcartitem')
