...
def search_products(request):
    ...
    products = Product.objects.filter(Q(description__contains=query) | Q(title__contains=query) | Q(headline__contains=query) | Q(author__contains=query) | Q(isbn_number__contains=query), active=True)
