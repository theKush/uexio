...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'products_product', (
            ...
            ('sale_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=20, decimal_places=2, blank=True)),
        ...
        db.create_table(u'products_categoryimage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'products', ['CategoryImage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'products_categoryimage')
