...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'products_product', 'status',
                      self.gf('django.db.models.fields.CharField')(default='inactive', max_length=9),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'products_product', 'status')
    ...
    models = {
        ...
        u'products.product': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'sold_for': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '20', 'decimal_places': '2', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'inactive'", 'max_length': '9'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
