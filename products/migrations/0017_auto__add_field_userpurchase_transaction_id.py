...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserPurchase.transaction_id'
        db.add_column(u'products_userpurchase', 'transaction_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserPurchase.transaction_id'
        db.delete_column(u'products_userpurchase', 'transaction_id')
