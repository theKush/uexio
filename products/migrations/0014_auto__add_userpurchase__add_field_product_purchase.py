...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'products_userpurchase', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'products', ['UserPurchase'])

        # Adding field 'Product.purchase'
        db.add_column(u'products_product', 'purchase',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.UserPurchase'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'UserPurchase'
        db.delete_table(u'products_userpurchase')

        # Deleting field 'Product.purchase'
        db.delete_column(u'products_product', 'purchase_id')
