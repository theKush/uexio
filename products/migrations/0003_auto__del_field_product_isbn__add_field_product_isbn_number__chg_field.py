...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.isbn'
        db.delete_column(u'products_product', 'isbn')
        ...
        # Changing field 'Product.author'
        db.alter_column(u'products_product', 'author', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):
        # Adding field 'Product.isbn'
        db.add_column(u'products_product', 'isbn',
        ...
        # Changing field 'Product.author'
        db.alter_column(u'products_product', 'author', self.gf('django.db.models.fields.CharField')(max_length=120, null=True))
