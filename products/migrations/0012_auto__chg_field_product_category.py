...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'products_product', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['products.Category']))

    def backwards(self, orm):

        # Changing field 'Product.category'
        db.alter_column(u'products_product', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Category'], null=True))
