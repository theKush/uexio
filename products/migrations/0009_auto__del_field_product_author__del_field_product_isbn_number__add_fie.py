...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'products_product', 'author')

        # Deleting field 'Product.isbn_number'
        db.delete_column(u'products_product', 'isbn_number')

        # Adding field 'Product.headline'
        db.add_column(u'products_product', 'headline',
                      self.gf('django.db.models.fields.CharField')(max_length=300, null=True),
                      keep_default=False)

        # Adding field 'Product.condition'
        db.add_column(u'products_product', 'condition',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'products_product', 'author',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.isbn_number'
        db.add_column(u'products_product', 'isbn_number',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.headline'
        db.delete_column(u'products_product', 'headline')

        # Deleting field 'Product.condition'
        db.delete_column(u'products_product', 'condition')
