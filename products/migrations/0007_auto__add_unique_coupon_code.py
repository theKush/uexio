...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Coupon', fields ['code']
        db.create_unique(u'products_coupon', ['code'])


    def backwards(self, orm):
        # Removing unique constraint on 'Coupon', fields ['code']
        db.delete_unique(u'products_coupon', ['code'])
